...
os.system('sudo docker cp rs/send-'+prog_name+'.py ' + container_name + '://scripts/send.py') 
os.system('sudo docker cp rs/receive-'+prog_name+'.py ' + container_name + '://scripts/receive.py')
